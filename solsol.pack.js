(function () {
    ...
    css.innerHTML = ".solsol {width : 100%;height: 100%;min-width: 512px;min-height: 480px;position: relative;left: 0;top: 0; border:1pt solid navy; border-radius: 5pt; background-color: rgba(250,250,250,0.7); }" +
        ".solsol_card {position: absolute;width: 57px;height: 83px;background-image: url('https://raw.githubusercontent.com/nls-jajuko/oskari-extensions/develop/resources/games/bundle/solsol/svg-cards-2.0-scaledDown.png');box-shadow: 0px 3px 4px rgba(0, 0, 0, 0.80);}";
