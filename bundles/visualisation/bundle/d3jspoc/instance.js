/**
 * @class Oskari.visualisation.bundle.d3jspoc.D3ProofOfConceptBundleInstance
 *
 * Add this to startupsequence to get this bundle started
 {
            ...
            sv : '?',
            en : '?',
            bundlename : 'visualisation',
            bundleinstancename : 'visualisation',
            metadata : {
                "Import-Bundle" : {
                    "visualisation" : {
 ...
 */
Oskari.clazz.define("Oskari.visualisation.bundle.d3jspoc.D3ProofOfConceptBundleInstance",
...
function() {
    ...
    startExtension : function() {
        var me = this;
        this.plugins['Oskari.userinterface.Flyout'] = Oskari.clazz.create('Oskari.visualisation.bundle.d3jspoc.Flyout', this);
        this.plugins['Oskari.userinterface.Tile'] = Oskari.clazz.create('Oskari.visualisation.bundle.d3jspoc.Tile', this);
    },
